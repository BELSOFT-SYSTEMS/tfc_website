              ...
              <div style={{ marginLeft: '30px' }}>
                ...
                <div className="elementor-widget-container" style={{ display: 'flex', alignItems: 'left', justifyContent: 'left', textAlign: 'left', height: '100vh', marginTop:'80px' }}>
                  <div style={{ textAlign: 'left' }}>
                    <h2 className="elementor-heading-title elementor-size-default" style={{ fontSize: '100px',fontWeight: 'bolder', color: '#000' }}>
                    Restoration Prayer.
                      </h2>
                      <h2 className="elementor-heading-title elementor-size-default" style={{ fontSize: '30px', fontWeight: 'bold', color: '#000' }}>

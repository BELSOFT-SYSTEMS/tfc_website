  ...
  return (
    <>
      ...
      <div style={{marginLeft:'30px',marginRight:'30px',paddingRight:'60px', paddingLeft:'60px'}}>
        <h1 style={{fontSize:'60px', textAlign:'left', fontWeight:'bolder'}}>What Is Restoration Prayer?</h1>
        <p style={{fontSize:'15px',}}>The Restoration Prayer process leads you through a time of systematic confession and repentance, standing in the authority that you have because of Jesus Christ, breaking lies, and replacing them with truth.</p>
        </div>
        <div style={{marginLeft:'30px', marginRight:'30px',paddingRight:'60px', paddingLeft:'60px', marginTop:'30px'}}>
          <h2 style={{fontSize:'60px', textAlign:'left', fontWeight:'bolder'}}>Why Is Restoration Prayer Important?</h2>
          <p style={{ fontSize:'15px',}}>Without spiritual bondage, the Holy Spirit is then able to have greater influence in and through you. The fruit of that Spirit will be able to grow more abundantly, and you will learn to hear the voice of God more clearly.</p>
        </div>
        <h3 style={{marginTop:'30px',fontSize:'15px', textAlign:'left', fontWeight:'bold',marginLeft:'30px', marginRight:'30px',paddingRight:'60px', paddingLeft:'60px',}}>Restoration Prayer revolves around:</h3>
        ...
        <img src="icons/bible-teachings.jpeg" alt="Icon" style={{ width: '98px', height: '98px', marginRight: '20px' }} />
          <div>
          <h3 style={{fontSize:'25px', fontWeight:'500', lineHeight:'30px'}}>

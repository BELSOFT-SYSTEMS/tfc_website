  ...
  return (
    <div style={{ paddingTop: '20px', paddingBottom: '40px' }}>
      ...
      <ButtonGroup size="lg" style={{ justifyContent: 'center', display: 'flex', flexDirection: flexDirection, textAlign: 'center', margin: '0 60px', gap: '15px', paddingBottom: '60px', height: '100px' }}>
        <Button variant="outline-success" onClick={() => handleSelect('eden')} active={activeKey === 'eden'} style={{ fontSize: '16px', fontWeight: '600' }}><FontAwesomeIcon icon={faChurch} style={{ color: '#d49c04', }} /> Eden</Button>
        <Button variant="outline-success" onClick={() => handleSelect('mpape')} active={activeKey === 'mpape'} style={{ fontSize: '16px', fontWeight: '600' }}><FontAwesomeIcon icon={faChurch} style={{ color: '#d49c04' }} /> Mpape</Button>
        <Button variant="outline-success" onClick={() => handleSelect('enugu')} active={activeKey === 'enugu'} style={{ fontSize: '16px', fontWeight: '600' }}><FontAwesomeIcon icon={faChurch} style={{ color: '#d49c04' }} /> Enugu</Button>
        <Button variant="outline-success" onClick={() => handleSelect('online')} active={activeKey === 'online'} style={{ fontSize: '16px', fontWeight: '600' }}><FontAwesomeIcon icon={faChurch} style={{ color: '#d49c04' }} /> Online</Button>
      </ButtonGroup>
            ...
            <Row>
              ...
              <Col xs={12} md={7} style={{ padding: '0 60px', }}>
                ...
                <div>
                  <Button
                    variant="success"
                    style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#d49c04', color: '#fff', width:'200px', height: '40px', textTransform: 'uppercase', fontSize: '16px', fontWeight: '600', border: 'none', }}
                    href="#"
                  > 
                    More Information
                  </Button>

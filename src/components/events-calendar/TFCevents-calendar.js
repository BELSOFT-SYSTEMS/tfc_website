...
const TFCeventscalendar = () => {
  return (
    <Container>
    <Container style={{justifyContent:'center', textAlign:'center',marginTop:'50px', marginBottom:'30px', marginTop:'20px'}}>
      <Row>
          <Col>
            <h2 style={{fontSize:'35px'}}>Upcoming Events <br/> At The Father's Church</h2>
